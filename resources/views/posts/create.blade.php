                    ...
                    <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="space-y-12">
                            <div class="pb-12 border-b border-gray-900/10">
                                <h2 class="text-base font-semibold leading-7 text-gray-900">New Posts</h2>
                                <p class="mt-1 text-sm leading-6 text-gray-600">This article will be published throught
                                    all the cyber</p>
